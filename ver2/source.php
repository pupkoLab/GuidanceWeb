...
1. Download the <a href="guidance.v2.02.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v2.02.tar.gz download');" >GUIDANCE source code</a>. <br>
<ul><b>2016, October 26 - releasing <a href="guidance.v2.02.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v2.02.tar.gz download');" >version 2.02:</a><br></b>
       Supporting newer gcc versions (up until version 6.20), minor bugfixes</b></ul>
<ul><b>2015, November 24 - releasing <a href="guidance.v2.01.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v2.01.tar.gz download');" >version 2.01:</a><br></b>
       Minor bugfixes</b></ul>
<ul><b>2014, September 7 - releasing <a href="guidance.v2.0.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v2.0.tar.gz download');" >version 2.0:</a><br></b>
<B><font size="+1" color="red">New and improved GUIDANCE2 algorithm implemeted, see <a href="http://guidance.tau.ac.il/overview.php">overview</a> for details</B></ul></font>
<ul><b>2014, August 7 - releasing <a href="guidance.v1.5.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v1.5.tar.gz download');" >version 1.5:</a><br></b>
           Other way to calculate col_col score which account for gap positions, bugfixes</b></ul>
<ul><b>2013, December 22 - releasing <a href="guidance.v1.4.1.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v1.4.1.tar.gz download');" >version 1.4.1:</a><br></b>
           Added support for new versions of PRANK and MAFFT, bugfixes</b></ul>
<ul><b>2012, October 24 - releasing <a href="guidance.v1.3.1.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v1.3.1.tar.gz download');" >version 1.3.1:</a><br></b>
           Minor bugfixes</b></ul>
<ul><b>2012, October 3 - releasing <a href="guidance.v1.3.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v1.3.tar.gz download');" >version 1.3:</a><br></b>
           Added support for new versions of PRANK, bugfixes</b></ul>
<ul><b>2012, June 22 - releasing <a href="guidance.v1.2.tar.gz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v1.2.tar.gz download');" >version 1.2:</a><br></b>
           Added support for the new aligner PAGAN, parallelization, reduced running time, bugfixes</b></ul>
<ul><b>2011, May 2 - releasing <a href="guidance.v1.1.tgz" onclick="ga('send', 'event', 'Download', 'Downloaded', 'guidance.v1.1.tar.gz download');" >version 1.1:</a><br></b>
...
This will create a directory named guidance.v2.02<br>
<br>
3. Make: <br>
<p>
<blockquote>
cd guidance.v2.02<br>
make
</blockquote>
</p>
